...
if __name__ == "__main__":
    ...
    tests = [
        ...
        {"dim": 3, "label": "Ray along Y-axis with obstacles", "x_0": np.array([2, 0, 3]), "x_f": np.array([2, 0, 3]), "obstacles": [ np.array([1, 2, 3]), np.array([1, 3, 3]),  np.array([2, 2, 2]), np.array([2, 3, 2]), np.array([2, 2, 3]),np.array([1, 3, 2])], "loose_dimension": 2},
        ...
        # Integer-only test cases
        {"dim": 2, "label": "Integer Optimized 2D", "x_0": np.array([0, 0]), "x_f": np.array([10, 10]), "obstacles": [], "loose_dimension": 1},
        {"dim": 3, "label": "Integer Optimized 3D", "x_0": np.array([0, 0, 0]), "x_f": np.array([10, 10, 10]), "obstacles": [], "loose_dimension": 1},
        {"dim": 3, "label": "Integer Optimized 3D with Obstacles", "x_0": np.array([1, 1, 1]), "x_f": np.array([8, 8, 8]), "obstacles": [np.array([4, 4, 4])], "loose_dimension": 1},
